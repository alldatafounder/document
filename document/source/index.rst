...
* 1、17+大模块39+核心功能，支持信创版本+国产数据库版本，满足企业响应国家信创战略要求；

* 2、底层底座：标准化数据平台，统一数据存储、接入与治理能力；

* 3、中间枢纽：一体化数据中台，打通全域数据资产，实现数据共享复用；

* 4、模型工厂：专业机器学习平台，支撑算法训练、特征加工与模型迭代；

* 5、上层应用：行业大模型应用，面向业务场景交付智能化落地产品。
